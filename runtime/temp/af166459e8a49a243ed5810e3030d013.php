<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/plugin\index.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="flexigrid">
        ...
        <div class="bDiv" id="tab_pay" style="height: auto;<?php if($type != 'payment' AND $type != ''): ?>display: none;<?php endif; ?>">
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                <table>
                    <tbody>
                    <?php if(is_array($payment) || $payment instanceof \think\Collection): $i = 0; $__LIST__ = $payment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td class="sign">
                                <div style="width: 24px;"><i class="ico-check"></i></div>
                            </td>
        ...
        <div class="bDiv" id="tab_login" style="height: auto;<?php if($type != 'login'): ?>display: none;<?php endif; ?>">
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                <table>
                    <tbody>
                    <?php if(is_array($login) || $login instanceof \think\Collection): $i = 0; $__LIST__ = $login;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td class="sign">
                                <div style="width: 24px;"><i class="ico-check"></i></div>
                            </td>
        ...
        <div class="bDiv" id="tab_shipping" style="height: auto;<?php if($type != 'shipping'): ?>display: none;<?php endif; ?>">
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                <table>
                    <tbody>
                    <?php if(is_array($shipping) || $shipping instanceof \think\Collection): $i = 0; $__LIST__ = $shipping;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td class="sign">
                                <div style="width: 24px;"><i class="ico-check"></i></div>
                            </td>
        ...
        <div class="bDiv" id="tab_function" style="height: auto;<?php if($type != 'function'): ?>display: none;<?php endif; ?>">
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                <table>
                    <tbody>
                    <?php if(is_array($function) || $function instanceof \think\Collection): $i = 0; $__LIST__ = $function;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td class="sign">
                                <div style="width: 24px;"><i class="ico-check"></i></div>
                            </td>
