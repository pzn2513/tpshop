<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/admin/view2/goods\ajaxGoodsList.html";i:1490352994;}*/ ?>
<table>
       <tbody>
            <?php if(is_array($goodsList) || $goodsList instanceof \think\Collection): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
              <tr>
			 ...
			 <td class="handle" >
                <div style="text-align:left;   min-width:50px !important; max-width:inherit !important;">
                  ...
                  <ul>
                    ...
                    <li><a href="javascript:void(0);" onclick="del('<?php echo $list[goods_id]; ?>')">删除商品</a></li>
                ...
                <td align="center" axis="col0">
                  <div style="text-align: center; width: 150px;"><?php echo $catList[$list[cat_id]][name]; ?></div>
                </td>
                <td align="center" axis="col0">
                ...
                <td align="center" axis="col0">                  
                <div style="text-align: center; width: 50px;">
                  <input type="text" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onChange="changeTableVal('goods','goods_id','<?php echo $list['goods_id']; ?>','store_count',this)" size="4" value="<?php echo $list['store_count']; ?>" />
                </div>                  
                </td>           
                <td align="center" axis="col0">                  
                <div style="text-align: center; width: 50px;">
